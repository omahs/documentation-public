...
<Steps>
  ...
  <Step title="Timestamp">
    Take the timestamp of the request in mlliseconds and add it as `orderly-timestamp` to the request header.
  </Step>
  ...
  <Step title="Generate a signature">
    ...
    - Concatenate the timestamp with the request method and request path
