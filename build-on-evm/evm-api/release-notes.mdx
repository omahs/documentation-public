...
## TBA
Added Smart Contract trading support
...
Added create algo order(GET /v1/algo/order), edit algo order(PUT /v1/algo/order), cancel algo order(DELETE /v1/algo/order) and get algo order APIs(GET /v1/algo/order). Only STOP orders are supported for now.

Added address and order_tag parameter in get broker daily statistics(GET /v1/volume/broker/daily) API
