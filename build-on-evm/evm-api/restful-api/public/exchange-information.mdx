...
``` shell cURL
curl 'https://api-evm.orderly.org/v1/public/info/PERP_BTC_USDC.e'
```

```python Python
import requests

url = "https://api-evm.orderly.org/v1/public/info/PERP_BTC_USDC.e"
...
var config = {
   method: 'get',
   url: 'https://api-evm.orderly.org/v1/info/PERP_BTC_USDC.e',
   headers: {}
};
