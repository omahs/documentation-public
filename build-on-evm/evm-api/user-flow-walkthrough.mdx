...
2. Check if the account is already registered via [Get account](/build-on-evm/evm-api/restful-api/public/get-account) API
...
| brokerHash  | bytes | Y        | The keccak256 hash of the broker id (eg "woofi_dex") |
