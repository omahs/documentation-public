...
2. Check if the account is already registered via [Get account](https://orderly.network/docs/build-on-evm/evm-api/restful-api/public/get-account) API
...
1. Send all the necessary information via [Add Orderly key](https://orderly.network/docs/build-on-evm/evm-api/restful-api/public/add-orderly-key) API
