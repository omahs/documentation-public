...
Users need to be authenticated before subscribing to any topic. They would be disconnected if authentication fails. For more information, refer to the [Authentication](/build-on-evm/evm-api/websocket-api/authentication) section.
