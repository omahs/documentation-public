...
- TS SDK
    ...
    - [React webhooks](https://sdk.orderly.network/docs/hooks/overview)

    - [React UI components](https://sdk.orderly.network/components/introduction)
...
- **Broker Setup:** Get [in touch](mailto:product@orderly.network) with Orderly team to set up broker_id, broker admin wallet, and default fee rates.
...
- **Account Registration:** Registering a user account with Orderly. Each user’s wallet can have one account per broker on Orderly. Documentation [here](/build-on-evm/user-flows/accounts).
...
## Post-integration
**Orderly Announcements Channel:** Join the [Telegram channel](https://t.me/+VnpoOvYpJXA2ZTc1) for updates and announcements.
...
**Tech Support Setup:** Establish a technical support system for handling user queries and technical issues. Orderly has a tech support team to handle any user or tech issues brokers may encounter.