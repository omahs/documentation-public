...
<Accordion title="Broker admin wallet">
  ...
  Broker admin wallet is used for: - Receiving fee rebates daily - Accessing certain endpoints that
  require broker admin authentication such as changing user fees. (Endpoints that require broker
