...
<Steps>
  <Step title="Choose a valid chain/broker to register the account on">
    List of chains can be found [here](/build-on-evm/smart-contract-api/addresses) and supported brokers through [Get list of brokers API](/build-on-evm/evm-api/restful-api/public/get-broker-list).
  </Step>
