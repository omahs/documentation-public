...
<Steps>
  <Step title="Approve spending of the token by the Vault smart contract">
    Get Vault & USDC deposit address from [here](/build-on-evm/smart-contract-api/addresses#arbitrum-chain-id-421613).
...
<Steps>
  <Step title="Choose a valid chain to withdraw your funds to">
    A list of supported chains can be found on our [Smart Contract Addresses page](/build-on-evm/smart-contract-api/addresses).
  </Step>
