...
![](/images/build-on-orderly/Orderly%20V2%20flow%20(1).png)
...
2. 2.  
Check if the account is already registered via <Get account> API
...
1. 1.  
Approve spending of the token by the smart contract
