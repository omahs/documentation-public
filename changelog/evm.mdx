...
To learn more about how the Orderly Referral System works, refer to [this article](/product-details/referral-system).
...
To learn more about how the new fee structure works, refer to [this article](/product-details/custom-fees).
...
Full write-up of how Delegate Signer functionality works can be found in [this article](/product-details/delegate-signer).
   ...
   <Snippet file="chips/updates.mdx" />
      ...
      >
        **Updates to Index Price computation methodology**

Improved algorithm for calcuating Index price. 

More information can be found [here](trade-on-orderly/perpetual-futures/mark-price-index-price-and-last-price).
