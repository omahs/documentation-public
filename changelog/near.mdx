...
## [Unreleased] February 5, 2024 - Minor Update
...
<div style={{ display: "table", width: "auto" }}>
  ...
  <div style={{ display: "table-row", width: "auto" }}>
   <Snippet file="chips/times.mdx" />
      ...
      TESTNET Feb 1, 2024 15:00pm (UTC +8)

MAINNET Feb 5, 2024 15:00pm (UTC +8)
  ...
  <div style={{ display: "table-row", width: "auto" }}>
   <Snippet file="chips/updates.mdx" />
      ...
      >
        ...
        **Updates to Index price computation**

We have improved the Index price computation methodology. More information on how we compute the Index price can be found [here](trade-on-orderly/perpetual-futures/mark-price-index-price-and-last-price).
