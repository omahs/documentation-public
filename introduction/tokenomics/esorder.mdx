...
When a user redeems esORDER for ORDER ahead of the full period of time (i.e. 90 days), a fraction of the rewards is burnt, introducing a burning mechanism that might lead to deflation.
