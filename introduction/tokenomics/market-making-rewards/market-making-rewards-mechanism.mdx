...
500,000 $ORDER is allocated for each epoch for all qualified Orderly market makers. From epoch 11 onwards, the market maker rewards will be distributed as [escrowed $ORDER](/introduction/market-making-rewards/market-making-rewards-mechanism) instead of liquid $ORDER tokens in epochs 1\-10. Any further adjustment of the distribution mechanism will be formally assessed and communicated to market makers in advance. 
