...
3. There is a waiting period of up to 4 days after each epoch for the validate of rewards distribution before users can start to claim their epoch rewards. During this period, Orderly will conduct wash trading analysis
...
4. Market makers can claim their epoch market making rewards (\$ORDER token) to the blockchain network they are connected to on the Orderly App. Rewards earned do not expire.
    ...
    - All market makers can choose which network they would like to claim their rewards regardless of which blockchain network they have traded on with Orderly’s builders. Gas fees will paid paying on-chain native gas on the selected chain to 
