...
- Whenever a user redeems their VALOR, the respective amount of redeemed VALOR will be burned. This permanently reduces the VALOR supply and increases the weight of the remaining VALOR.
    ...
    - Note: Other users’ VALOR redemption will not affect your proportion of the treasury. In other words, your earned VALOR will be worth more USDC regardless if others have redeemed their VALOR.
