...
## Rules
- Refer to [Trading Rewards](/introduction/tokenomics/trading-rewards/trading-rewards-mechanism) for the distribution schedule, mechanisms, and formulas.
...
3. There is a 5 days waiting period after each epoch for the validate of rewards distribution before users can start to claim their epoch rewards. During the waiting period, Orderly will conduct a wash trading analysis to penalize potential users who have self-traded during the epoch. This is imperative to ensure that legitimate users are fairly rewarded.
...
4. Users can claim their epoch trading rewards (\$ORDER token) to the blockchain network they are connected to on the Orderly App. Rewards earned do not expire.
    ...
    - All users can choose which network they would like to claim their rewards regardless of which blockchain network they have traded on with Orderly’s builders. Gas fees will paid paying on-chain native gas on the selected chain to 
        ...
        1. \$ORDER (ERC-20) will be received by users when claiming rewards on Ethereum L1

        2. \$ORDER (OFT) will be received by users when claiming rewards on all other blockchain network


## Trading Rewards Interface
Access the [Orderly App](app.orderly.network/tradingRewards) and connect to your wallet to view your trading rewards statistics.

<img
  className="block dark:hidden"
  src="/images/trading-rewards.png"
  alt="Trading Rewards Page"
/>
