...
[usePositionStream](/sdks/hooks/advanced/use-position-stream) provides the current position details of the account, and includes some useful data calculations for showing positions, including:
